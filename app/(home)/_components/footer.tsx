    ...
    return (
        <footer className="w-full flex items-center p-6 text-white bg-[#1A2033]">
            <div className="flex flex-wrap items-center justify-center w-full max-w-6xl gap-8 mx-auto md:flex-nowrap md:justify-between md:gap-0">
                ...
                <nav>
                    <ul className="flex items-center justify-start gap-x-6 sm:gap-x-8">
                        <li><Link className="text-xs sm:text-sm" href="/about-us">About Us</Link></li>
                        <li><Link className="text-xs sm:text-sm" href="/contact-us">Contact Us</Link></li>
                        <li>
